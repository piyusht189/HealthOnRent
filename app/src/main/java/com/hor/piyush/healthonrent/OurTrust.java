...
public class OurTrust extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_our_trust);
        ...
        this.mWebview.loadUrl("http://healthonrent.in/our-trust/");
            ...
            extends WebViewClient
    {
        ...
        public void onPageFinished(WebView paramWebView, String paramString)
        {
            ...
            OurTrust.this.mWebview.loadUrl("javascript:(function() { document.getElementsByTagName('header')[0].style.display='none';document.getElementsByTagName('footer')[0].style.display='none'; })()");
        ...
        {
            progress=new ProgressDialog(OurTrust.this);
